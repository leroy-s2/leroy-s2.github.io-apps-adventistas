...
import { Monitor, Apple, Heart, Send, MessageSquare, Lightbulb } from 'lucide-react';
            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link
                    to="/project/himnario-adventista"
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8">
            <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <MessageSquare size={20} className="text-adventist-accent" />
              Ideas de la comunidad
            </h3>
            <div className="space-y-3">
              <div className="glass-card rounded-xl p-4">
                <p className="text-gray-300 text-sm">"Una app para llevar registro de estudios bíblicos"</p>
                <span className="text-gray-500 text-xs">— Sugerencia popular</span>
              </div>
              <div className="glass-card rounded-xl p-4">
                <p className="text-gray-300 text-sm">"Lección de Escuela Sabática con audios"</p>
                <span className="text-gray-500 text-xs">— Sugerencia popular</span>
              </div>
              <div className="glass-card rounded-xl p-4">
                <p className="text-gray-300 text-sm">"Devocional matutino con notificaciones"</p>
                <span className="text-gray-500 text-xs">— Sugerencia popular</span>
              </div>
            </div>
          </div>
